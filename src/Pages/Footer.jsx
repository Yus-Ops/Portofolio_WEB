...
const Footer = () => {
  ...
  return (
    <footer id="Footer" className="bg-white border-t border-slate-200 py-12 px-[5%] sm:px-[10%]">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-slate-600 mb-4">Machine Learning Engineer</p>
            <div className="flex space-x-4">
              <a href="https://github.com/Yus-Ops" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="bg-emerald-50 p-2 rounded-full text-emerald-600 hover:bg-emerald-100 transition-colors">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/in/yus-ops" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="bg-emerald-50 p-2 rounded-full text-emerald-600 hover:bg-emerald-100 transition-colors">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=yus.ahm399@gmail.com" aria-label="Email" className="bg-emerald-50 p-2 rounded-full text-emerald-600 hover:bg-emerald-100 transition-colors">
                <Mail className="w-5 h-5" />
              </a>
              <a href="https://instagram.com/scastlivy_" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="bg-emerald-50 p-2 rounded-full text-emerald-600 hover:bg-emerald-100 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Python', 'PyTorch', 'TensorFlow', 'Keras', 'scikit-learn', 'Hugging Face', 'Docker', 'MLflow'].map((tech, index) => (
                <li key={index}>
