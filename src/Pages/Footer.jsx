        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#footer" className="text-slate-600 hover:text-emerald-500 transition-colors flex items-center gap-2"><ExternalLink className="w-4 h-4" /> Contact</a></li>
            </ul>
          </div>
